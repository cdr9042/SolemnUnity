...
namespace SS.Scene
{
    public class SceneWindow : EditorWindow
    {
        ...
        void OnGUI()
        {
            ...
            ownCamera = EditorGUILayout.Toggle("Own Camera", ownCamera);
        ...
        void SetupScene()
        {
            ControllerSupporter cs = GameObject.FindObjectOfType<ControllerSupporter>();
            cs.gameObject.name = sceneName;

            Controller c = cs.gameObject.GetComponent<Controller>();
            if (c != null)
            {
                DestroyImmediate(c);
            }
            ...
            cs.gameObject.AddComponent(type);

            c = cs.gameObject.GetComponent<Controller>();
            c.FullScreen = fullScreen;
            c.OwnCamera = ownCamera;
