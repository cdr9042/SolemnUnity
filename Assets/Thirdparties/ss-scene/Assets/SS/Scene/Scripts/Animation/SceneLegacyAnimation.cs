...
namespace SS.Scene
{
    public class SceneLegacyAnimation : SceneAnimation
    {
        ...
        void Awake()
        {
            ...
            {
                if (SceneManager.SceneAnimationDuration > 0)
                {
                    Animation[m_ShowAnimName].speed = Animation[m_ShowAnimName].length / SceneManager.SceneAnimationDuration;
                    Animation[m_HideAnimName].speed = Animation[m_HideAnimName].length / SceneManager.SceneAnimationDuration;
                }
            }
        }
