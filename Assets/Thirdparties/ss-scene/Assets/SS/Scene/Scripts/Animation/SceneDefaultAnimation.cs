    ...
    public class SceneDefaultAnimation : SceneAnimation
    {
        ...
        void Awake()
        {
            if (Application.isPlaying)
            {
                ...
                {
                    m_AnimationDuration = SceneManager.SceneAnimationDuration;
                }
                else
                {
        ...
        protected override void ApplyProgress(float progress)
        {
            ...
            switch (m_AnimationType)
            {
                ...
                case AnimationType.Fade:
                    ...
                    break;
                default:
                    RectTransform.anchoredPosition = new Vector2(ease(m_Start.x, m_End.x, progress), ease(m_Start.y, m_End.y, progress));
                    break;
            }
        }
