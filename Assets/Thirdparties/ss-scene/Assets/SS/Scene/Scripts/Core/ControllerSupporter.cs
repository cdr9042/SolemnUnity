...
namespace SS.Scene
{
    ...
    public class ControllerSupporter : MonoBehaviour
    {
        ...
        public void Show()
        {
            if (m_Controller.Animation != null)
            {
                m_Controller.Animation.HideBeforeShowing();
            }
            m_State = State.SHOW;
            m_FrameCounter = 0;
        }
        ...
        void OnEnable()
        {
            if (Application.isPlaying && m_Controller != null && m_Controller.OwnCamera)
            {
                SceneManager.ActivateBackgroundCamera(false);
            }
        }
        ...
        void OnDestroy()
        {
            if (Application.isPlaying && m_Controller != null && m_Controller.OwnCamera)
            {
                SceneManager.ActivateBackgroundCamera(true);
            }
        }
